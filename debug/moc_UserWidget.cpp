...
template <> constexpr inline auto UserWidget::qt_create_metaobjectdata<qt_meta_tag_ZN10UserWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'handleJoinGroup'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'handleLeaveGroup'
...
void UserWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->loginRequested(); break;
        case 2: _t->handleCreateGroup(); break;
        case 3: _t->handleJoinGroup(); break;
        case 4: _t->handleLeaveGroup(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (UserWidget::*)()>(_a, &UserWidget::registrationRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (UserWidget::*)()>(_a, &UserWidget::loginRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void UserWidget::registrationRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void UserWidget::loginRequested()
{
